...
## 3. 사용된 기법
**1. Data augmentation**
- image flip (right, left), rotation 등을 사용<br>

**2. ELU(Exponential linear unit) 사용**  
- ELU가 cifar에서 괜찮은 성능을 나타낸다고 해서 사용<br>

**3. Dropout 사용**  
- 3개 이상 부터는 효과는 좋을 텐데 5분내로 끝내기가 쉽지 않았다.<br>

**4. weight regularization 사용**  
- 어떤 weight의 성분이 급격히 커지면 억제하는 역할을 한다. L2 regularizer 사용.<br>
  ```python
